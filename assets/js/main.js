...
// Get all shopping bag buttons
var shoppingBagButtons = document.querySelectorAll('.bx-shopping-bag');

// Attach event listener to each shopping bag button
shoppingBagButtons.forEach(function(button) {
  button.addEventListener('click', function() {
    var item = button.parentElement.dataset.item;
    addToCart(item);
